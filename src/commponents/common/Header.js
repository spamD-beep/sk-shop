...
<div className='container-fluid'>
      <div className='row border-top-0 border-bottom-0 d-flex header justify-content-between w-100 align-items-center'>
        <div className='col-6'>
            <div className='top-p'>Get up to 50% off new season styles, limited time only</div>
        </div>
        <div className='col-6 d-flex help-center justify-content-end align-items-center gap-3'>
            <a href="#" className='border-end border-end-1 border-0'>Help Center</a>
            <a href="#" className='border-end border-end-1 border-0'>Order Tracking</a>
    ...
    <div className='main'>
      <div className="container-fluid second">
        <div className='row logo'>
            ...
            <input type="text" className='w-100 search border-0' placeholder='Search for products...'/>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search-icon lucide-search"><path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/></svg>
            </div>
            <div className='col-3 login'>
                <a href="#" className='pe-2'>Login</a>
                <a href="#">Register</a>
